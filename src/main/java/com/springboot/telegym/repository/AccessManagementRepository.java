...
public interface AccessManagementRepository extends JpaRepository<AccessManagement, String> {
    ...
    @Procedure(procedureName = "Identify_Checkin_Data")
    ...
    List<AccessManagement> ListCustomerInClass(@Param("id_class") String id_class);

    @Procedure(procedureName = "Number_Customer_In_Class")
